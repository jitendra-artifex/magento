...
class AW_Helpdeskultimate_Block_Adminhtml_Tickets_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        if (is_null($this->getRequest()->getParam('filter', null)) &&
        ...
        elseif (!is_null($this->getRequest()->getParam('sort', null)) ||
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
            ->joinLeft(array('u' => $t1), 'u.user_id=locked_by', array('locked_name' => 'CONCAT("by ", u.firstname," ",u.lastname," at ", locked_at)'))
